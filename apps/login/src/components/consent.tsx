  ...
  return (
    <div className="flex w-full flex-col items-center space-y-4 pt-4">
      <ul className="w-full list-disc space-y-2">
        {scopes?.length === 0 && (
          <span className="flex w-full flex-row items-center rounded-md border border-divider-light bg-background-light-400 px-4 py-2 text-sm transition-all">
        ...
        {scopes?.map((s) => {
          ...
          return (
            <li
              key={s}
              className="flex w-full flex-row items-center rounded-md border border-divider-light bg-background-light-400 px-4 py-2 text-sm transition-all"
            >
